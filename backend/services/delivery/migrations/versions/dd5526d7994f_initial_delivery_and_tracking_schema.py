...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('created', 'assigned', 'picked_up', 'in_transit', 'delivered', 'cancelled', name='deliverystatus'), server_default='created', nullable=False),
    ...
    op.create_index(op.f('ix_deliveries_hub_id'), 'deliveries', ['hub_id'], unique=False)
